...
This exposes the Web Console (9000), ILP ingestion (9009), PostgreSQL wire (8812), and health endpoint (9003).
...
You should see the QuestDB [Web Console](/docs/web-console/).
...
| Port | Service |
|------|---------|
| `9000` | [REST API](/docs/reference/api/rest/) and [Web Console](/docs/web-console/) |
| `9009` | [InfluxDB Line Protocol (ILP)](/docs/reference/api/ilp/overview/) |
