...
- [Point-in-time recovery](/docs/operations/point-in-time-recovery/) - Recover QuestDB Enterprise to an arbitrary instant by restoring a backup base and replaying replicated WAL: the two-step procedure, the commit-time semantics of the recovery target, verifying against silent partial recovery, and cold storage handling
