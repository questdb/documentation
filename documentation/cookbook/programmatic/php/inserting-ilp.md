...
For complete ILP specification, see the [ILP reference documentation](/docs/connect/compatibility/ilp/overview/).
...
- [ILP reference documentation](/docs/connect/compatibility/ilp/overview/)
- [HTTP REST API](/docs/connect/compatibility/rest-api/)
