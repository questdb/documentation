...
- [SQL ENGINE ADMIN](/docs/security/rbac/#permissions) - Now also gates creating, altering and dropping resource groups, mapping principals to them, and reading `resource_groups()`
