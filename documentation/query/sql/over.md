...
We also have some [common examples](/docs/query/functions/window#common-window-function-examples) to get you started.
...
- Calculating [moving averages](/docs/query/functions/window#avg) or
  [cumulative sums](/docs/query/functions/window#cumulative-bid-size)
...
function like [`avg()`](/docs/query/functions/window#avg) to calculate it. But this would only give you a single
...
- [`avg()`](/docs/query/functions/window#avg) – Calculates the average within a window

- [`count()`](/docs/query/functions/window#count) – Counts rows or non-null values

- [`dense_rank()`](/docs/query/functions/window#dense_rank) – Assigns a rank to rows monotonically

- [`first_value()`](/docs/query/functions/window#first_value) – Retrieves the first value in a window

- [`lag()`](/docs/query/functions/window#lag) – Accesses data from previous rows

- [`last_value()`](/docs/query/functions/window#last_value) – Retrieves the last value in a window

- [`lead()`](/docs/query/functions/window#lead) – Accesses data from subsequent rows

- [`max()`](/docs/query/functions/window#max) – Returns the maximum value within a window

- [`min()`](/docs/query/functions/window#min) – Returns the minimum value within a window

- [`rank()`](/docs/query/functions/window#rank) – Assigns a rank to rows

- [`row_number()`](/docs/query/functions/window#row_number) – Assigns sequential numbers to rows

- [`sum()`](/docs/query/functions/window#cumulative-bid-size) – Calculates the sum within a window
...
common window function examples, please check the [Window functions reference](/docs/query/functions/window#common-window-function-examples).
