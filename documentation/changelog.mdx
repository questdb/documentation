...
- [Configuration reference](/docs/configuration/) - Revamped into 17 dedicated per-subsystem pages with epigraph-style property listings

### New

- [Upgrade QuestDB](/docs/operations/upgrade/) - Guide for upgrading QuestDB versions
- [Table/column versioning](/docs/concepts/root-directory-structure/) - Added versioning info to root directory structure
...
- Added [Parquet bloom filters](/docs/query/sql/alter-table-alter-column-parquet-encoding/) syntax and configuration
...
- [Per-column Parquet encoding and compression](/docs/query/sql/alter-table-alter-column-parquet-encoding/) - Comprehensive documentation for column-level settings
