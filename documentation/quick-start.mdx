...
[server configuration](/docs/configuration/) files depend on the chip:
...
| `9009` | [InfluxDB Line Protocol (ILP)](/docs/reference/api/ilp/overview/) - Legacy TCP, use HTTP instead |
