...
- [Access control functions](/docs/query/functions/access-control/) - Query `active_permissions()` for effective ACL permissions, including group inheritance, or `active_grants()` for direct grants across users, groups, and service accounts in QuestDB Enterprise
