...
See [building the Authorization header manually](/docs/connect/compatibility/rest-api/#building-the-authorization-header-manually)
for how to produce that value, and
[authentication via token](/docs/connect/compatibility/rest-api/#authentication-via-token-in-questdb-enterprise)
