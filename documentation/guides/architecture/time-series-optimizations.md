...
An alternative is to use QuestDB Enterprise to automatically move older partitions to [cold storage](/docs/guides/architecture/storage-engine/#tier-three-parquet-locally-or-in-an-object-store), with
