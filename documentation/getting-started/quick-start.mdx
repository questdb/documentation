...
| Port | Service |
|------|---------|
| `9000` | [REST API](/docs/connect/compatibility/rest-api/) and [Web Console](/docs/getting-started/web-console/overview/) |
| `9009` | [InfluxDB Line Protocol (ILP)](/docs/connect/compatibility/ilp/overview/) - Legacy TCP, use HTTP instead |
...
_Want more options? See the [ingestion overview](/docs/connect/overview/)._
