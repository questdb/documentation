...
- [ILP reference](/docs/connect/compatibility/ilp/overview/)
- [ILP over HTTP](/docs/connect/compatibility/ilp/overview/#transport-selection)
- [ILP over TCP](/docs/connect/compatibility/ilp/overview/#transport-selection)
