...
integration is to use the <a href="https://oauth.net/2/grant-types/password" target="_blank" rel="noopener noreferrer">
...
If the <a href="https://oauth.net/2/grant-types/password" target="_blank" rel="noopener noreferrer">
