...
export default function CustomNavbarItems() {
  ...
  const repoUrl = `https://github.com/questdb/questdb/`
  ...
  return (
    <>
      ...
      <div
        className="navbar__item dropdown dropdown--hoverable dropdown--left min-w-fit"
      ...
      >
        ...
        >
          ...
          <span style={{ display: "flex", alignItems: "center", gap: "4px" }}>
            ...
            >
              <svg
                className="navbar__star-count-icon"
                aria-hidden="true"
                height="16"
                viewBox="0 0 16 16"
                version="1.1"
        ...
        <ul
          ...
          style={{ width: "170px", padding: "0.2rem 0.5rem" }}
        >
          <li>
            <Link
