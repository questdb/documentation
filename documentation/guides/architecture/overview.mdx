...
- **[Replication](/docs/concept/replication/):** QuestDB Enterprise supports
  high availability with read replicas and multi-primary configurations.
  See [High Availability](/docs/concept/replication/) for details.
...
- **[Web console](/docs/web-console/):** The engine includes
...
Continue to [Storage Engine](/docs/guides/architecture/storage-engine/) to learn how QuestDB stores and manages data on disk.
